...
from main.views import show_main, create_products, show_products, purchase_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, delete_product
